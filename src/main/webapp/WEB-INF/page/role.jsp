...
<button type="button" class="btn btn-primary" style="float:right;" onclick="window.location.href='${pageContext.request.contextPath}/user/toAddRole'"><i class="glyphicon glyphicon-plus"></i> 新增</button>
<br>
 <hr style="clear:both;">
        ...
        <script type="text/javascript">
			...
			function isDel(idx) {
				...
				if (confirm("确定要删除当前角色吗？")){
					//如果是 去跳转到退出的业务
					window.location.href="${pageContext.request.contextPath}/user/delRole?roleId="+idx;
				}else {
					//啥也不做
				}
			}
