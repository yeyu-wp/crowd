                                        ...
                                        <div class="col-md-12 column">
                                            <div class="panel panel-default">
                                                <div class="panel-body" style="padding:60px;">
                                                    <i class="glyphicon glyphicon-ok" style="color:green;font-size:40px;"></i> <span style="margin-left:20px;">${CURRENT_USER.userName},你发起的众筹项目信息已经提交完毕，我们会在5~7个工作日内对项目进行审核，请耐心等候</span>
