				...
				<ul style="padding-left:0px;" class="list-group">
					...
					<li class="list-group-item">
						...
						<ul style="margin-top:10px;">
							<li style="height:30px;">
								<a href="${pageContext.request.contextPath}/user/toReal" style="color:red;"><i class="glyphicon glyphicon-check"></i> 实名认证审核</a>
							</li>
							<li style="height:30px;">
            ...
            <table class="table  table-bordered">
			  ...
			  <c:forEach items="${real}" var="real">
                <tr>
                  <td>${real.prId}</td>
                  <td>${real.prName}</td>
                  <td>${real.prVersion}</td>
                  <td>${real.jName}</td>
                  <td>${real.userName}</td>
                  <td>
                      <button type="button" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></button>
				      <button type="button" class="btn btn-danger btn-xs" onclick="window.location.href='${pageContext.request.contextPath}/user/delReal?prId=${real.prId}'"><i class=" glyphicon glyphicon-remove"></i></button>
				  </td>
                </tr>
			  </c:forEach>
              </tbody>
