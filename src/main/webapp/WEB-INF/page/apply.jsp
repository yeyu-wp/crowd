    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active" ><a href="apply"><span class="badge">1</span> 基本信息</a></li>
            <li role="presentation" ><a href="apply-1"><span class="badge">2</span> 资质文件上传</a></li>
		...
		<form action="apply-1" role="form" style="margin-top:20px;" method="get">
		  <div class="form-group">
			<label for="personName">真实名称</label>
			<input type="text" class="form-control" id="personName" name="personName" placeholder="请输入真实名称" value="${param.personName}">
		  </div>
		  <div class="form-group">
			<label for="personIdCard">身份证号码</label>
			<input type="text" class="form-control" id="personIdCard"  name="personIdCard" placeholder="请输入身份证号码" value="${param.personIdCard}">
		  </div>
		  <div class="form-group">
			<label for="personTel">电话号码</label>
			<input type="text" class="form-control" id="personTel" name="personTel" placeholder="请输入电话号码" value="${param.personTel}">
		  </div>
          <button type="button" onclick="window.location.href='accttype.html'" class="btn btn-default">上一步</button>
		  <input type="submit"   class="btn btn-success" value="下一步"></button>
		</form>
		<hr>
    </div> <!-- /container -->
