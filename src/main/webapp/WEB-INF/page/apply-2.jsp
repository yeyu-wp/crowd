    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation" class="active"><a href="apply-2"><span class="badge">3</span> 邮箱确认</a></li>
		...
		<form role="form" style="margin-top:20px;">
          ...
          <button type="button" onclick="window.location.href='apply-1'" class="btn btn-default">上一步</button>
		  <button type="button" onclick="window.location.href='apply-3'"  class="btn btn-success">下一步</button>
		</form>
		<hr>
    </div> <!-- /container -->
