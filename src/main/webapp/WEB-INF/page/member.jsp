                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="member.jsp"><i class="glyphicon glyphicon-scale"></i> 会员中心</a></li>
        ...
        <div class="col-sm-3 col-md-3 column">
            <div class="row">
                <div class="col-md-12">
                    <div class="thumbnail" style="    border-radius: 0px;">
                        <img src="${pageContext.request.contextPath}/resource/img/tx3.jpg" class="img-thumbnail" alt="">
            ...
            <div class="list-group">
                ...
                <div class="list-group-item " style="cursor:pointer;"
                     onclick="window.location.href='${pageContext.request.contextPath}/user/mycrowd'">
...
<script src="${pageContext.request.contextPath}/resource/script/echarts.js"></script>
<script>
