...
<html lang="GB18030">
  <head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resource/ztree/zTreeStyle.css">
	<style>
	.tree li {
  ...
  <body>
				...
				<ul style="padding-left:0px;" class="list-group">
					...
					<li class="list-group-item">
						...
						<ul style="margin-top:10px;">
							...
							<li style="height:30px;">
								<a href="${pageContext.request.contextPath}/user/findAllRole"><i class="glyphicon glyphicon-king"></i> 角色维护</a>
							</li>
							<li style="height:30px;">
								<a href="${pageContext.request.contextPath}/user/toPer" style="color:red;"><i class="glyphicon glyphicon-lock"></i> 许可维护</a>
							</li>
						</ul>
					</li>
					<li class="list-group-item tree-closed">
						...
						<ul style="margin-top:10px;display:none;">
							<li style="height:30px;">
								<a href="${pageContext.request.contextPath}/user/toReal"><i class="glyphicon glyphicon-check"></i> 实名认证审核</a>
							</li>
							<li style="height:30px;">
								<a href="${pageContext.request.contextPath}/user/toAdv"><i class="glyphicon glyphicon-check"></i> 广告审核</a>
							</li>
							<li style="height:30px;">
	...
	<script src="${pageContext.request.contextPath}/resource/ztree/jquery.ztree.all-3.5.min.js"></script>
