    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" ><a href="${pageContext.request.contextPath}/user/viewname/apply"><span class="badge">1</span> 基本信息</a></li>
            ...
            <li role="presentation"  class="active"><a href="apply-3"><span class="badge">4</span> 申请确认</a></li>
        </ul>
