...
<form:form   modelAttribute="user" action="${pageContext.request.contextPath}/user/findUserNoRole" method="post">
						...
						<table class="table  table-bordered">
							...
							<c:forEach items="${role}" var="role" varStatus="status">
								<tr>
									...
									<td>${role.roleName}</td>
									<td>
										<button type="button"  class="btn btn-success btn-xs" onclick="addRole(${role.roleId})"><i class=" glyphicon glyphicon-ok"></i></button>
...
<script type="text/javascript">
	...
	function addRole(roleId) {
		if (confirm("确认添加角色吗？")) {
			...
			alert(userId);
			window.location.href = "${pageContext.request.contextPath}/user/addUserRole?roleId="+roleId+"&userId="+userId;
