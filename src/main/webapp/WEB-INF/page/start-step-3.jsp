            ...
            <div class="col-md-12 column">
                <div class="panel panel-default" >
                    ...
                    <div class="panel-footer" style="text-align:center;">
                        <button type="button" class="btn  btn-default btn-lg" onclick="window.location.href='${pageContext.request.contextPath}/user/reward/step2?goodid=${goodid}&goodPrice=${goodPrice}'">上一步</button>
                        <button type="button" class="btn  btn-warning btn-lg" onclick="window.location.href='${pageContext.request.contextPath}/user/reward/step4'">提交</button>
                        <a class="btn" > 保存草稿 </a>
                    </div>
                </div>
            </div>
